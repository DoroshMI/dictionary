 ...
 * @see org.dorosh.dictionary.member.User
 * @see org.dorosh.dictionary.member.Employee
 */
@Entity
@Table(name="USERS")
...
public abstract class User implements Serializable {
     ...
     */
    public User(String firstName, String lastName, String username, String password, Date dateCreated, boolean accountVerified) {
